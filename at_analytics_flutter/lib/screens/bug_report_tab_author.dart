...
class ListBugReportTabAuthor extends StatefulWidget {
  final BugReportService? bugReportService;
  final bool isAuthorAtSign;
  final String? atSign;
  const ListBugReportTabAuthor({
    Key? key,
  ...
  @override
  _ListBugReportTabAuthorState createState() => _ListBugReportTabAuthorState();
}

class _ListBugReportTabAuthorState extends State<ListBugReportTabAuthor>
