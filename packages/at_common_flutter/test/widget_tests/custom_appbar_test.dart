...
void main() {
  ...
  group('CustomAppBar Widget tests', () {
    ...
    testWidgets('CustomAppBar with leading Icons enabled', (WidgetTester tester) async {
      var uniqueKey = const Key('testIcon');
      await tester.pumpWidget(homeWidget(
          home: CustomAppBar(
        titleText: 'Welcome Screen',
        showTitle: true,
        leadingIcon: IconButton(key: uniqueKey, icon: const Icon(Icons.menu), onPressed: () {}),
    ...
    testWidgets('CustomAppBar with leading Icons disabled', (WidgetTester tester) async {
      await tester.pumpWidget(homeWidget(
          home: const CustomAppBar(
        titleText: 'Welcome Screen',
        showTitle: true,
    ...
    testWidgets('CustomAppBar with backbuttons and leading icons enabled', (WidgetTester tester) async {
      var uniqueKey = const Key('testIcon');
      await tester.pumpWidget(homeWidget(
          home: CustomAppBar(
        titleText: 'Welcome Screen',
    ...
    testWidgets('CustomAppBar with backbuttons enabled and leadingIcons disabled', (WidgetTester tester) async {
      await tester.pumpWidget(homeWidget(
          home: const CustomAppBar(
        titleText: 'Welcome Screen',
        showTitle: true,
    ...
    testWidgets('CustomAppBar with trailing Icons enabled', (WidgetTester tester) async {
      var uniqueKey = const Key('testIcon');
      await tester.pumpWidget(homeWidget(
          home: CustomAppBar(
        titleText: 'Welcome Screen',
    ...
    testWidgets('CustomAppBar with trailing Icons disabled', (WidgetTester tester) async {
      var uniqueKey = const Key('testIcon');
      await tester.pumpWidget(homeWidget(
          home: CustomAppBar(
        titleText: 'Welcome Screen',
    ...
    testWidgets('CustomAppBar with closeOnRight and trailing icons enabled', (WidgetTester tester) async {
      var uniqueKey = const Key('testIcon');
      await tester.pumpWidget(homeWidget(
          home: CustomAppBar(
        titleText: 'Welcome Screen',
      ...
      expect(find.byKey(uniqueKey), findsNothing);
      final appBar = tester.widget<CustomAppBar>(find.byType(CustomAppBar));
      expect(find.byWidgetPredicate((Widget widget) => widget is Text && widget.data == TextStrings().buttonClose),
          findsOneWidget);
      expect(appBar.onTrailingIconPressed!.call(), null);
    });
  });
