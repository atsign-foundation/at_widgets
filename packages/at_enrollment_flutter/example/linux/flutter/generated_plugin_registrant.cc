...
#include <at_enrollment_flutter/at_enrollment_flutter_plugin.h>
...
void fl_register_plugins(FlPluginRegistry* registry) {
  g_autoptr(FlPluginRegistrar) at_enrollment_flutter_registrar =
      fl_plugin_registry_get_registrar_for_plugin(registry, "AtEnrollmentFlutterPlugin");
  at_enrollment_flutter_plugin_register_with_registrar(at_enrollment_flutter_registrar);
