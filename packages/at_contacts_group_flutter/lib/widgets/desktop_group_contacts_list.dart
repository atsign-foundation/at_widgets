...
import 'package:at_contacts_group_flutter/widgets/desktop_custom_list_tile.dart';
      ...
      children: [
        Row(
          ...
          children: [
            ...
            IconButtonWidget(
              icon: AllImages().trust,
              backgroundColor: AllColors().iconButtonColor,
              isSelected: showTrustedContacts,
              onTap: () async {
                if (!showTrustedContacts) {
                  await GroupService().getTrustedContacts().then((value) {
                    if (GroupService().trustedContacts.isNotEmpty) {
                      ...
                      setState(() {
                        trustedContactsList
                            .addAll(GroupService().trustedContacts);
