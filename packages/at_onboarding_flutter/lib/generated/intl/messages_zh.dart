...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(givenAtsign) => "atSign不匹配。请提供${givenAtsign}的二维码进行配对。";

  static String m1(givenAtsign) => "atSign不匹配。请提供${givenAtsign}的备份密钥文件进行配对。";

  static String m2(atsign) => "${atsign}已与该设备配对。请先从设备中删除/重置此atSign才能添加。";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "activate_an_atSign":
            MessageLookupByLibrary.simpleMessage("激活一个atSign"),
        "already_have_an_atSign":
            MessageLookupByLibrary.simpleMessage("已经有atSign了吗？"),
        "atSign_mismatches_need_to_provide_QRCode": m0,
        "atSign_mismatches_need_to_provide_backupKey": m1,
        "btn_activate_atSign": MessageLookupByLibrary.simpleMessage("激活atSign"),
        ...
        "btn_generate_atSign":
            MessageLookupByLibrary.simpleMessage("生成一个免费atSign"),
        ...
        "enter_atSign_need_to_activate":
            MessageLookupByLibrary.simpleMessage("输入您想要激活的atSign"),
        ...
        "error_atSign_activated": MessageLookupByLibrary.simpleMessage(
            "此atSign已被激活。请上传您的atKeys与该设备配对"),
        "error_atSign_already_paired": m2,
        "error_atSign_logged":
            MessageLookupByLibrary.simpleMessage("此atSign已激活并与该设备配对"),
        ...
        "error_invalid_atSign_provided":
            MessageLookupByLibrary.simpleMessage("提供的atSign无效。请联系管理员。"),
        ...
        "get_free_atSign": MessageLookupByLibrary.simpleMessage("获取免费atSign"),
        ...
        "learn_about_atSign":
            MessageLookupByLibrary.simpleMessage("了解更多关于atSign的信息"),
        "learn_more": MessageLookupByLibrary.simpleMessage("了解更多"),
        "loading_atSigns": MessageLookupByLibrary.simpleMessage("正在加载atSign"),
        "msg_action_cannot_undone":
            MessageLookupByLibrary.simpleMessage("警告：此操作无法撤销"),
        "msg_atSign_cannot_empty":
            MessageLookupByLibrary.simpleMessage("atSign不能为空"),
        "msg_atSign_not_registered": MessageLookupByLibrary.simpleMessage(
            "您的atSign尚未注册。请尝试使用已注册的atSign。"),
        "msg_atSign_required":
            MessageLookupByLibrary.simpleMessage("需要一个atSign。"),
        "msg_atSign_unreachable": MessageLookupByLibrary.simpleMessage(
            "您的atSign和服务器无法访问。请重试或联系support@atsign.com"),
        ...
        "msg_maximum_atSign_next":
            MessageLookupByLibrary.simpleMessage("来选择您现有的atSign之一。"),
        "msg_maximum_atSign_prev":
            MessageLookupByLibrary.simpleMessage("糟糕！您已经拥有了最大数量的免费atSign。请登录到"),
        "msg_refresh_atSign":
            MessageLookupByLibrary.simpleMessage("刷新直到您看到您喜欢的atSign，然后点击配对"),
        ...
        "msg_wait_fetching_atSign":
            MessageLookupByLibrary.simpleMessage("请等待获取atSign状态"),
        "no_atSigns_paired_to_reset":
            MessageLookupByLibrary.simpleMessage("没有atSign需要重置。"),
        ...
        "pair_atSign":
            MessageLookupByLibrary.simpleMessage("使用您的atKeys配对atSign"),
        ...
        "title_intro": MessageLookupByLibrary.simpleMessage(
            "此应用程序基于atPlatform构建。所有atPlatform应用程序都需要一个atSign。"),
        ...
        "title_select_atSign": MessageLookupByLibrary.simpleMessage(
            "您已经有了一些现有的atSign。请选择一个atSign，或者继续使用新的atSign。"),
        "title_session_expired":
            MessageLookupByLibrary.simpleMessage("您的会话已过期"),
        "title_setting_up_your_atSign":
            MessageLookupByLibrary.simpleMessage("设置您的atSign"),
        "title_shared_storage": MessageLookupByLibrary.simpleMessage(
            "您是否希望将此已集成的atSign与atPlatform上的其他应用程序共享？"),
        "tutorial_activate_your_atSign":
            MessageLookupByLibrary.simpleMessage("点击此处激活您的atSign"),
        "tutorial_generate_atSign":
            MessageLookupByLibrary.simpleMessage("点击此处生成新的免费atSign"),
        "tutorial_get_atSign":
            MessageLookupByLibrary.simpleMessage("如果您没有atSign，请点击此处获取一个"),
        "tutorial_scan_QRCode":
            MessageLookupByLibrary.simpleMessage("点击此处扫描二维码"),
        "tutorial_upload_atSign_key":
            MessageLookupByLibrary.simpleMessage("如果您有atSign，请点击此处上传atSign密钥"),
