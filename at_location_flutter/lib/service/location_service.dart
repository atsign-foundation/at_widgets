...
class LocationService {
  ...
  Map<String, HybridModel> hybridUsersList = {};

  late StreamController _atHybridUsersController =
      StreamController<Map<String, HybridModel>>.broadcast();
  Stream<Map<String, HybridModel>> get atHybridUsersStream =>
      _atHybridUsersController.stream as Stream<Map<String, HybridModel>>;
  StreamSink<Map<String, HybridModel>> get atHybridUsersSink =>
      _atHybridUsersController.sink as StreamSink<Map<String, HybridModel>>;
  ...
  void updateMyLatLng(HybridModel _myData) async {
    /// TODO: Add before calculating eta
    /// and notify
    if (etaFrom != null) {
    ...
    hybridUsersList[AtLocationNotificationListener().currentAtSign!] = _myData;
  ...
  void addCentreMarker() {
    ...
    hybridUsersList[textForCenter!] = centreMarker!;
  ...
  Future<void> addDetails(HybridModel user, {int? index}) async {
    try {
      ...
      user.eta = _eta;
      hybridUsersList[user.displayName!] = user;
