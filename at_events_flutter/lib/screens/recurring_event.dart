...
class _RecurringEventState extends State<RecurringEvent> {
  ...
  void initState() {
    ...
    eventData = EventNotificationModel.fromJson(
        jsonDecode(EventNotificationModel.convertEventNotificationToJson(EventService().eventNotificationModel!)));
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Row(
              ...
              children: <Widget>[
                CustomInputField(
                  ...
                  initialValue:
                      eventData!.event!.repeatDuration != null ? eventData!.event!.repeatDuration.toString() : '',
                  value: (String val) {
            ...
            isRepeatEveryWeek
                ? Container(
                    ...
                    child: DropdownButton<String>(
                      ...
                      elevation: 0,
                      dropdownColor: AllColors().INPUT_GREY_BACKGROUND,
                      value: eventData!.event!.occursOn != null ? getWeekString(eventData!.event!.occursOn) : null,
                ...
                : CustomInputField(
                    ...
                    initialValue: eventData!.event!.date != null ? dateToString(eventData!.event!.date!) : '',
                    onTap: () async {
                      DateTime? datePicked = await showDatePicker(
                        context: context,
                        initialDate: (eventData!.event!.date != null) ? eventData!.event!.date! : DateTime.now(),
            ...
            Row(
              ...
              children: <Widget>[
                CustomInputField(
                  ...
                  icon: Icons.access_time,
                  initialValue:
                      eventData!.event!.startTime != null ? timeOfDayToString(eventData!.event!.startTime!) : '',
                  onTap: () async {
                ...
                CustomInputField(
                  ...
                  hintText: 'Stop',
                  icon: Icons.access_time,
                  initialValue: eventData!.event!.endTime != null ? timeOfDayToString(eventData!.event!.endTime!) : '',
                  onTap: () async {
                    TimeOfDay? timePicked = await showTimePicker(
                        context: context,
                    ...
                    if (timePicked != null) {
                      eventData!.event!.endTime = DateTime(eventData!.event!.date!.year, eventData!.event!.date!.month,
                          eventData!.event!.date!.day, timePicked.hour, timePicked.minute);
                      setState(() {});
                    }
                  },
                ),
            ...
            CustomInputField(
              ...
              initialValue:
                  (eventData!.event!.endEventOnDate != null) ? dateToString(eventData!.event!.endEventOnDate!) : '',
              onTap: () async {
                DateTime? datePicked = await showDatePicker(
                  context: context,
            ...
            Center(
              child: CustomButton(
                onPressed: () {
                  String? formValid = EventService().checForRecurringeDayEventFormValidation(eventData!);
