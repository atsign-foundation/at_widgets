...
class _CustomDialogState extends State<CustomDialog> {
  ...
  /// Validate person based on the atsign, email and otp
  ...
  /// Displays the [AlertDialog] if the maximum atsign limit is reached
  /// Displays list of the atsigns registered with the email ID
