...
class _PairAtsignWidgetState extends State<PairAtsignWidget> {
  ...
  /// Checks the permission status of camera and storage in the device
  ...
  /// Requests the user permissons for camera and storage
  ...
  /// Returns the [CustomDialog] error message
